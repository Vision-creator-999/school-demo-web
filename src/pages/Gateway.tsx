...
import { School, ArrowRight, Globe, Sparkles, BookOpen, Award } from 'lucide-react';
...
export const Gateway: React.FC = () => {
  ...
  const bgImage = "https://lh3.googleusercontent.com/gps-cs-s/AHRPTWk1vrMTJ4NSsgKuZ73cSERWvmCK38kK183ICtzH5DW5WtJXxA9-geECwVZJO7xkaoIYx5sYWfs2TVvSvS7ewAqc-KwhKx69yMyNRIhtfBiKmURKG6fo2kjaNyEIb4wmmCCU7ko=s1360-w1360-h1020-rw";
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between items-center bg-slate-950 text-white overflow-hidden font-sans select-none">
      ...
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover z-0 opacity-40 scale-105 animate-fade-in"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/70 to-slate-950/40 z-0 pointer-events-none" />
      ...
      <main className="relative z-10 w-full max-w-5xl px-4 py-12 flex flex-col items-center text-center my-auto">
        {/* Welcome Tag & Headline */}
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-500/20 to-blue-500/20 border border-teal-400/30 px-4 py-1.5 rounded-full text-teal-300 text-xs font-extrabold tracking-wider uppercase mb-6 backdrop-blur-md shadow-sm">
          <Sparkles size={14} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full max-w-4xl">
          ...
          <div
            ...
            className="group relative bg-slate-900/80 hover:bg-slate-900/95 border border-white/15 hover:border-teal-400/60 rounded-2xl p-8 transition-all duration-500 flex flex-col justify-between items-start text-left cursor-pointer shadow-2xl hover:shadow-teal-500/10 backdrop-blur-xl hover:-translate-y-1.5"
          >
            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-25 transition-opacity text-teal-400">
              <BookOpen size={96} />
            </div>

            <div>
              <div className="inline-flex items-center gap-1.5 bg-teal-400/10 border border-teal-400/30 px-3 py-1 rounded-md text-teal-300 text-[11px] font-extrabold uppercase tracking-wider mb-5">
                <Award size={13} />
            ...
            <button className="w-full py-3.5 px-6 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-400 hover:to-teal-500 text-slate-950 font-extrabold text-sm rounded-xl transition-all duration-300 shadow-lg flex items-center justify-between group-hover:shadow-teal-500/25">
          ...
          <div
            ...
            className="group relative bg-slate-900/80 hover:bg-slate-900/95 border border-white/15 hover:border-amber-400/60 rounded-2xl p-8 transition-all duration-500 flex flex-col justify-between items-start text-left cursor-pointer shadow-2xl hover:shadow-amber-500/10 backdrop-blur-xl hover:-translate-y-1.5"
          >
            <div className="absolute top-0 right-0 p-6 opacity-10 group-hover:opacity-25 transition-opacity text-amber-400">
              <BookOpen size={96} />
            </div>

            <div>
              <div className="inline-flex items-center gap-1.5 bg-amber-400/10 border border-amber-400/30 px-3 py-1 rounded-md text-amber-300 text-[11px] font-extrabold uppercase tracking-wider mb-5">
                <Award size={13} />
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-8 font-devanagari">
                उत्तर प्रदेश माध्यमिक शिक्षा परिषद द्वारा मान्यता प्राप्त संपूर्ण हिंदी माध्यम संकाय, साहित्य एवं प्राविधिक शिक्षा।
              </p>
            </div>

            <button className="w-full py-3.5 px-6 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-extrabold text-sm rounded-xl transition-all duration-300 shadow-lg flex items-center justify-between group-hover:shadow-amber-500/25">
