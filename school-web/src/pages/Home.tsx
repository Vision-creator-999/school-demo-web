...
import { ArrowRight, BookOpen, Award, Users, ShieldCheck, ChevronLeft, ChevronRight, AlertCircle, CheckCircle } from 'lucide-react';
      ...
      <section className="py-16 md:py-20 text-center px-4 max-w-5xl mx-auto w-full flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl rounded-2xl overflow-hidden border-4 border-white shadow-xl bg-white select-none">
          ...
          <div className="relative aspect-video w-full overflow-hidden">
            ...
            <div className="absolute bottom-0 inset-x-0 bg-primary-dark/80 backdrop-blur-xs py-3 px-6 text-cream text-center text-xs sm:text-sm font-semibold border-t border-white/5">
              {isHindi ? carouselImages[carouselIndex].captionHi : carouselImages[carouselIndex].captionEn}
            </div>
          </div>
